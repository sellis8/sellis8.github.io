...
const connectionString = `postgres://postgres:CTI_110_WakeTech@localhost/Ellis_Gradebook`;
// The default password is CTI_110_WakeTech
// The default database name is Ellis_Gradebook
...
router.get('/', function(req, res){
    ...
    // from the same directory it's in, called Ellis_Gradebook.html
    res.sendFile(path.join(__dirname, 'Ellis_Gradebook.html'));
});
